# Contributing to Laravel Werkos

Thank you for considering contributing to Laravel Werkos! We welcome contributions from the community and are grateful
...
1. Clone the repository:
   ```bash
   git clone https://github.com/shavonn/laravel-werkos.git
   cd laravel-werkos
   ```

   *Note: If you don't have write access to the repository, you'll need to fork it first and clone your fork instead:*
   ```bash
   git clone https://github.com/your-username/laravel-werkos.git
   ```
...
2. Create a pull request:
    - Go to the [Laravel Werkos repository](https://github.com/shavonn/laravel-werkos)
...
All contributors will be credited in our:

- Release notes for the version including your contribution
...
This project follows Laravel/PSR-12 coding standards. You can check your code style with:
...
Thank you for contributing to Laravel Werkos! 🎉
